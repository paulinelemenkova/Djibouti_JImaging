...
\address[1]{%
  \hl{Department of Biological, Geological and Environmental Sciences, Alma Mater Studiorum}%MDPI: We arranged the authors’ address information from subordinate to superior. Please check and confirm this modification.
\hl{-}%MDPI: We changed -- to -, please confirm
Università di Bologna, Via Irnerio 42,   Emilia-Romagna, 40126 Bologna, \hl{IT,} %MDPI: Please confirm if it can be removed. We can keep it if it is province abbreviation
 Italy; polina.lemenkova2@unibo.it; Tel.: +39-\hl{3446928732} %MDPI: Please check if need add hyphen in it
}
...
The main goal{ }is to{ identify}{ changes in land cover types }of Djibouti using the {time series of }satellite images {by the reclassification scheme}. {\hl{GRASS GIS} %MDPI: Please state the version number of the software. All software used needs to be added with version number, please check it in the full text
...
\begin{figure}[H]
    ...
    \caption{\hl{Topographic} %MDPI: Please note that changes to the position/size of figures or tables may occur during the production stage.
...
\section{\highlighting{Materials and Methods} %MDPI: In Section Materials and Methods, if there is manufacturer, please state the name of the manufacturer, city, and country from where the equipment was sourced.
}\label{sec3}
...
\begin{table}[H]\small
\caption{\hl{Metadata and Identifiers (IDs) of the four multispectral Landsat 8-9 OLI/TIRS images covering the study area of Djibouti.} %MDPI: It is same as table 3 caption, please check if need keep
}
\label{tab01}
...
\begin{table}[H]
\caption{{\hl{Metadata}%MDPI: We removed the vertical lines in all tables. Please confirm.
...
\footnotesize 
 ...
 \toprule
        ...
        Date Acquired & \hl{2023/07/16} %MDPI: Please revise date format to  Date Month Year, e.g.,  1 January 2020. The same for the following highlights.
 & \hl{2021/08/19} & \hl{2017/07/23} & \hl{2015/07/02 }\\ \midrule
        Date Product Generated L2 & \hl{2023/07/19} & \hl{2021/08/27} & \hl{2020/09/03} & \hl{2020/09/09} \\ \midrule
        Date Product Generated L1 & \hl{2023/07/16} & \hl{2021/08/27} & \hl{2020/09/03} & \hl{2020/09/09} \\ \midrule
...
\vspace{-6pt}
\begin{table}[H]
\caption{\hl{Metadata and Identifiers (IDs) of the four multispectral Landsat 8-9 OLI/TIRS images covering study area of Djibouti.}}\label{tab03}
\setlength\tabcolsep{0pt}
\begin{tabularx}{\textwidth}{ X X X X}
\toprule
\textbf{N-S} & \textbf{Data Values} & \textbf{E-W} & \textbf{Data Values}\\
\midrule
	North: & 1\hl{,}%MDPI: We added commas to separate thousands for numbers with five or more digits. Please confirm.
395\hl{,}915.00 &  East: & 393\hl{,}015.00 \\
	South: &  1\hl{,}162\hl{,}485.00 &  West: & 164\hl{,}085.00 \\
	Resolution: &  30.00 m & Cells: & 59\hl{,}376\hl{,}811 \\
...
The {workflow is based on scripting techniques of} GRASS GIS {for image }analysis. {The} topographic map is plotted using  existing {techniques in {GMT}~\cite{WRIGHT1998737,Lemenkova202217,9921513,Lemenkova202203,10537274}. 
...
for each land cover class. The same was applied for all images for the years 2015, 2017, 2021 and 2023 with a biannual gap. The classification was performed using the maximum-likelihood discriminant analysis classifier by the `i.maxlik' module \cite{CHOWDHURY2024100800,Lemenkova202323}. {The algorithm used} the signature file{ }calculated in the previous step. {Using} the signature file, the land cover types{ were classified }using maximum-likelihood discriminant analysis (Figure \ref{fig05}).
 ...
 \begin{figure}[H]
    ...
    \caption{\hl{Maps} %MDPI: 1. Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". 2. Please confirm whether the overlapping/incomplete content in this figure affects scientific understanding and if it does, please revise it.
 of land cover types based on the classified Landsat 8 OLI/TIRS images from 2015, 2019, 2021 and 2023 covering Djibouti. The approach involved the maximum-likelihood discriminant analysis classifier. Background relief: GEBCO. Software: GRASS GIS. Mapping source: Author.}
    \label{fig05}
\end{figure}
...
The analysis of accuracy (Figure \ref{fig06}) revealed the areas of misclassified pixels {within water bodies}, %EE: Please check intended meaning is retained.­
...
\end{adjustwidth}
    ...
    \caption{\hl{Accuracy} %MDPI: We revised the hyphen in the figure into minus sign. Please confirm. Please confirm whether the overlapping/incomplete content in this figure affects scientific understanding and if it does, please revise it.
...
(Table} \ref{tabFAO}). This part of the work was performed using QGIS software, version \mbox{3.42.2 ‘M\"unster'}. 
...
\begin{adjustwidth}{-\extralength}{0cm}
%\centering %% If there is a figure in wide page, please release command \centering
\begin{tabularx}{\fulllength}{ p{0.6cm}  X  X  X  X  X  X  X  X  X  X  p{0.6cm} }
  \toprule
  \textbf{Class} & \rotatebox{90}{\textbf{\hl{Salt Plains} %MDPI: Please check whether the font direction of the table header should be maintained
}} & \rotatebox{90}{\makecell{\textbf{Barren} \\\textbf{Land}}} & \rotatebox{90}{\makecell{\textbf{Water}\\ \textbf{Bodies}}} & \rotatebox{90}{\textbf{Mangroves}} & \rotatebox{90}{\textbf{Shrubs}} & \rotatebox{90}{\textbf{Farmland}} & \rotatebox{90}{\makecell{\textbf{Built-Up} \\\textbf{Areas}}} & \rotatebox{90}{\textbf{Forest}} & \rotatebox{90}{\textbf{Cropland}}  & \rotatebox{90}{\makecell{\textbf{Sparse} \\\textbf{Vegegation}}} & \rotatebox{90}{\textbf{Total}} \\
   \midrule
...
\hspace{+2pt}\includegraphics[width=13.5cm]{Fig_07.jpg}
    ...
    \caption{\hl{Reclassified} %MDPI: We revised the hyphen in the figure into minus sign. Please confirm. Please confirm whether the overlapping/incomplete content in this figure affects scientific understanding and if it does, please revise it.
...
\hspace{+2pt}	\includegraphics[width=13.5cm]{Fig_08.jpg}
    ...
    \caption{\hl{Image} %MDPI: We revised the hyphen in the figure into minus sign. Please confirm. Please confirm whether the overlapping/incomplete content in this figure affects scientific understanding and if it does, please revise it.
...
\dataavailability{The data are available in the GitHub \hl{repository:} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.
\url{https://github.com/paulinelemenkova/GRASS\_ML\_Djibouti}.} 

\acknowledgments{The authors thank the reviewers for reading and reviewing of this manuscript.}
...
\begin{table}[H]\scriptsize
  ...
  \multirow{2}{*}{\textbf{Class}} & \multicolumn{7}{c}{\textbf{Initial Mean Values for Multispectral Bands of Landsat:  2015}} \\
    ...
    \midrule
    1 & 8103.97 & 8671.63 & 9562.73 & 9665.43 & 10\hl{,}%MDPI: We added commas to separate thousands for numbers with five or more digits. Please confirm. The same for the following highlights.
102 & 10\hl{,}216.9 & 9598.71 \\
    2 & 8421.69 & 9028.36 & 10\hl{,}061.5 & 10\hl{,}389.8 & 10\hl{,}972.8 & 11\hl{,}250.5 & 10\hl{,}522.6 \\
    3 & 8739.4 & 9385.08 &10\hl{,}560.2 & 11\hl{,}114.2 & 11\hl{,}843.6 & 12\hl{,}284.2 & 11\hl{,}446.6 \\
    4 & 9057.11 & 9741.81 & 11\hl{,}059 & 11\hl{,}838.6 & 12\hl{,}714.5 & 13\hl{,}317.8 & 12\hl{,}370.5 \\
    5 & 9374.82 & 10\hl{,}098.5 & 11\hl{,}557.7 & 12\hl{,}563 & 13\hl{,}585.3 & 14\hl{,}351.5 & 13\hl{,}294.4 \\
    6 & 9692.54 & 10\hl{,}455.3 & 12\hl{,}056.4 & 13\hl{,}287.4 & 14\hl{,}456.2 & 15\hl{,}385.1 & 14\hl{,}218.3 \\
    7 & 10\hl{,}010.2 & 10\hl{,}812 & 12\hl{,}555.2 & 14\hl{,}011.8 & 15\hl{,}327 & 16\hl{,}418.8 & 15\hl{,}142.3 \\
    8 & 10\hl{,}328 & 11\hl{,}168.7 & 13\hl{,}053.9 & 14\hl{,}736.2 & 16\hl{,}197.9 & 17\hl{,}452.4 & 16\hl{,}066.2 \\
    9 & 10\hl{,}645.7 & 11\hl{,}525.4 & 13\hl{,}552.7 & 15\hl{,}460.6 & 17\hl{,}068.7 & 18\hl{,}486.1 & 16\hl{,}990.1 \\
    10 & 10\hl{,}963.4 & 11\hl{,}882.1 & 14\hl{,}051.4 & 16\hl{,}185 & 17\hl{,}939.6 & 19\hl{,}519.7 & 17\hl{,}914 \\
\bottomrule
\end{tabularx}
...
\begin{table}[H]\footnotesize
  ...
  \multirow{2}{*}{\textbf{Class}} & \multicolumn{7}{c}{\textbf{Initial Mean Values for Multispectral Bands of Landsat:  2017}} \\
     & \textbf{1-Coastal Aerosol} & \textbf{2-Blue} & \textbf{3-Green} & \textbf{4-Red} & \textbf{5-NIR} & \textbf{6-SWIR-1} & \textbf{7-SWIR-2} \\
    \midrule
    1 & 8074.96 & 8660.92 & 9599.33 & 9725.17 & 10\hl{,}161.2 & 10\hl{,}291.9 & 9670.42 \\
    2 & 8390.09 & 9009.56 & 10\hl{,}079.2 & 10\hl{,}419.5 & 11\hl{,}011.6 & 11\hl{,}300.7 & 10\hl{,}555.8 \\
    3 & 8705.22 & 9358.2 & 10559.1 & 11\hl{,}113.9 & 11\hl{,}861.9 & 12\hl{,}309.4 & 11441.2 \\
    4 & 9020.35 & 9706.85 & 11\hl{,}039 & 11\hl{,}808.3 & 12\hl{,}712.3 & 13\hl{,}318.1 & 12\hl{,}326.7 \\
    5 & 9335.49 & 10\hl{,}055.5 & 11\hl{,}518.9 & 12\hl{,}502.6 & 13\hl{,}562.7 & 14\hl{,}326.9 & 13\hl{,}212.1 \\
    6 & 9650.62 & 10\hl{,}404.1 & 11\hl{,}998.8 & 13\hl{,}197 & 14\hl{,}413.1 & 15\hl{,}335.6 & 14\hl{,}097.5 \\
    7 & 9965.75 &10\hl{,}752.8 & 12\hl{,}478.7 &13\hl{,}891.4 & 15\hl{,}263.5 & 16\hl{,}344.3 & 14\hl{,}982.9 \\
    8 & 10\hl{,}280.9 & 11\hl{,}101.4 & 12\hl{,}958.6 & 14\hl{,}585.7 & 16\hl{,}113.8 & 17\hl{,}353.1 & 15\hl{,}868.3 \\
    9 & 10\hl{,}596 &11\hl{,}450.1 & 13\hl{,}438.5 & 15\hl{,}280.1 & 16\hl{,}964.2 & 18\hl{,}361.8 & 16\hl{,}753.7 \\
    10 & 10\hl{,}911.1 & 11\hl{,}798.7 & 13\hl{,}918.4 & 15\hl{,}974.4 & 17\hl{,}814.6 & 19\hl{,}370.5 & 17\hl{,}639.1 \\
\bottomrule
\end{tabularx}
...
\begin{table}[H]\footnotesize
 \caption{Initial mean values for pixels in spectral bands assigned to target land cover types in Djibouti for the image obtained on 19 August 2021, before iterative classification process.}
  ...
  \multirow{2}{*}{\textbf{Class}} & \multicolumn{7}{c}{\textbf{Initial Mean Values for Multispectral Bands of Landsat: 2021}} \\
     & \textbf{1-Coastal Aerosol} & \textbf{2-Blue} & \textbf{3-Green} & \textbf{4-Red} &\textbf{ 5-NIR} & \textbf{6-SWIR-1} & \textbf{7-SWIR-2} \\
    \midrule
    1 & 8317.6 & 8806.66 & 9565.01 & 9718.97 & 10\hl{,}254 & 10\hl{,}232.6 & 9622.06 \\
    2 & 8578.74 & 9106.8 & 10\hl{,}005.6 & 10\hl{,}359.3 & 11\hl{,}061 & 11\hl{,}207.5 & 10\hl{,}480.5 \\
    3 & 8839.87 & 9406.95 & 10\hl{,}446.1 & 10\hl{,}999.7 & 11\hl{,}867.9 & 12\hl{,}182.4 & 11\hl{,}338.9 \\
    4 & 9101 & 9707.09 & 10\hl{,}886.7 & 11\hl{,}640.1 & 12\hl{,}674.8 & 13\hl{,}157.4 & 12\hl{,}197.4 \\
    5 & 9362.13 &10\hl{,}007.2 & 11\hl{,}327.3 & 12\hl{,}280.4 & 13\hl{,}481.8 & 14\hl{,}132.3 & 13\hl{,}055.8 \\
    6 & 9623.26 & 10\hl{,}307.4 & 11\hl{,}767.8 & 12\hl{,}920.8 & 14\hl{,}288.7 & 15\hl{,}107.2 & 13\hl{,}914.3 \\
    7 & 9884.39 & 10\hl{,}607.5 & 12\hl{,}208.4 & 13\hl{,}561.1 & 15\hl{,}095.7 & 16\hl{,}082.1 & 14\hl{,}772.7 \\
    8 & 10\hl{,}145.5 & 10\hl{,}907.7 & 12\hl{,}649 & 14\hl{,}201.5 & 15\hl{,}902.6 & 17\hl{,}057.1 & 15\hl{,}631.2 \\
    9 & 10\hl{,}406.7 & 11\hl{,}207.8 & 13\hl{,}089.5 & 14\hl{,}841.9 & 16\hl{,}709.6 & 18\hl{,}032 & 16\hl{,}489.6 \\
    10 & 10\hl{,}667.8 & 11\hl{,}507.9 & 13\hl{,}530.1 & 15\hl{,}482.2 & 17\hl{,}516.5 & 19\hl{,}006.9 & 17\hl{,}348 \\
\bottomrule
\end{tabularx}
...
\begin{table}[H]\footnotesize
  ...
  \multirow{2}{*}{\textbf{Class}} & \multicolumn{7}{c}{\textbf{Initial Mean Values for Multispectral Bands of Landsat: 2023}} \\
     & \textbf{1-Coastal Aerosol} & \textbf{2-Blue} & \textbf{3-Green} & \textbf{4-Red} & \textbf{5-NIR} & \textbf{6-SWIR-1} & \textbf{7-SWIR-2} \\
    \midrule
    1 & 8504.75 & 9131.19 & 9993.94 & 10\hl{,}161.4 & 10\hl{,}600.6 & 10\hl{,}554.5 & 9880.58 \\
    2 & 8747.11 & 9404.01 & 10\hl{,}394.1 & 10\hl{,}760.9 & 11\hl{,}378.1 & 11\hl{,}500.1 & 10\hl{,}685.6 \\
    3 & 8989.47 & 9676.83 & 10\hl{,}794.3 & 11\hl{,}360.4 & 12\hl{,}155.5 & 12\hl{,}445.8 & 11\hl{,}490.6 \\
    4 & 9231.83 & 9949.65 & 11\hl{,}194.5 & 11\hl{,}960 & 12\hl{,}933 & 13\hl{,}391.4 & 12\hl{,}295.6 \\
    5 & 9474.19 & 10\hl{,}222.5 & 11\hl{,}594.7 & 12\hl{,}559.5 & 13\hl{,}710.4 & 14\hl{,}337 & 13\hl{,}100.6 \\
    6 & 9716.55 & 10\hl{,}495.3 & 11\hl{,}994.9 & 13\hl{,}159.1 & 14\hl{,}487.8 & 15\hl{,}282.7 & 13\hl{,}905.5 \\
    7 & 9958.91 & 10\hl{,}768.1 & 12\hl{,}395.1 & 13\hl{,}758.6 & 15\hl{,}265.3 & 16\hl{,}228.3 & 14\hl{,}710.5 \\
    8 & 10\hl{,}201.3 & 11\hl{,}040.9 & 12\hl{,}795.3 & 14\hl{,}358.1 & 16\hl{,}042.7 &17\hl{,}173.9 & 15\hl{,}515.5 \\
    9 & 10\hl{,}443.6 & 11\hl{,}313.7 & 13\hl{,}195.5 & 14\hl{,}957.7 & 16\hl{,}820.1 & 18\hl{,}119.6 & 16\hl{,}320.5 \\
    10 & 10\hl{,}686 & 11\hl{,}586.6 & 13\hl{,}595.7 & 15\hl{,}557.2 & 17\hl{,}597.6 & 19\hl{,}065.2 & 17\hl{,}125.5 \\
\bottomrule
\end{tabularx}
...
\vspace{-6pt}
\begin{table}[H]\scriptsize  
 \caption{Iterative process of pixel assignment to target classes during image classification: \hl{2015}%MDPI: We changed 2021 to 2015, please confirm
.}
  \centering
  ...
  \toprule
  \multirow{2}{*}{\textbf{2015}} & \multicolumn{10}{c}{\textbf{Pixel Distribution by Categories of Land Cover Classes: 201}5} \\
...
\end{equation}
\end{adjustwidth}
\caption{\hl{Class separability} %MDPI: We have adjusted the format of the figure, please confirm. We recommend changing it to Equation A1 instead of Figure A1
 matrices for classified images of Djibouti: \textbf{\hl{2015}%MDPI: Please confirm if the bold is unnecessary and can be removed. The following highlights are the same.
} and \textbf{\hl{2017}}.}
\label{figSep1}
\end{figure}
...
\end{equation}
\end{adjustwidth}
\caption{\hl{Class} %MDPI: We have adjusted the format of the figure, please confirm. We recommend changing it to Equation A2 instead of Figure A2
 separability matrices for classified images of Djibouti: \textbf{\hl{2021}} and \textbf{\hl{2023}}.}
\label{figSep2}
\end{figure}
...
\vspace{-6pt}
\begin{table}[H]\small
\caption{\hl{Computed} %MDPI: Please confirm the alignment change.
...
3 & 9230.46 & 9913.19 & 11\hl{,}%MDPI: We added commas to separate thousands for numbers with five or more digits. Please confirm. The same for the following highlights.
138.2 & 11\hl{,}958.2 & 12\hl{,}864.5 & 12\hl{,}862.9 & 11\hl{,}816.5 \\
4 & 9430.8 & 10\hl{,}146.6 & 11\hl{,}465.7 & 12\hl{,}446 & 13\hl{,}497.2 & 13\hl{,}806.2 & 12\hl{,}619 \\
5 & 9547.38 & 10\hl{,}303 & 11\hl{,}752.4 & 12\hl{,}912.6 & 14\hl{,}092.7 & 14\hl{,}641.3 & 13\hl{,}360.3 \\
6 & 9821.76 & 10\hl{,}624.5 & 12\hl{,}235.6 & 13\hl{,}635.1 & 14\hl{,}896.9 & 15\hl{,}478.6 & 14\hl{,}133.9 \\
7 & 10\hl{,}246.8 & 11\hl{,}081.6 & 12\hl{,}862.4 & 14\hl{,}552 & 16\hl{,}012.4 & 16\hl{,}653.6 & 15\hl{,}224.3 \\
8 & 10\hl{,}661.7 & 11\hl{,}544 & 13\hl{,}560.5 & 15\hl{,}543.5 & 17\hl{,}259.8 & 18\hl{,}626.3 & 17\hl{,}001.6 \\
9 & 11\hl{,}251.3 & 12\hl{,}246.2 & 14\hl{,}758.7 & 17\hl{,}309 & 19\hl{,}326.1 & 21\hl{,}064.2 & 19\hl{,}184.3 \\
10 & 11\hl{,}881.4 & 12\hl{,}946.1 & 15\hl{,}865.1 & 18\hl{,}729.9 & 20\hl{,}856 & 24\hl{,}277.4 & 22\hl{,}627.1 \\
\midrule
2017 &  &  &  & & & & \\
\midrule
1 & 7371.5 & 7875.98 & 8664.69 & 8356.38 & 8565.28 & 8995.22 & 8778.1 \\
2 & 8858.16 & 9357.22 & 9951.7 & 9564.73 & 9444.54 & 9371.12 & 8992.18 \\
3 & 8945.89 & 9777.33 & 11\hl{,}054.5 & 11\hl{,}333.4 & 11\hl{,}764 & 11\hl{,}571.8 & 10\hl{,}743 \\
4 & 9321.25 & 10\hl{,}018.9 & 11\hl{,}324 & 12\hl{,}242.3 & 13\hl{,}244.4 & 13\hl{,}468.5 & 12\hl{,}268.8 \\
5 & 9496.17 & 10\hl{,}212.7 & 11\hl{,}611.2 & 12\hl{,}696.3 & 13\hl{,}855.2 & 14\hl{,}375.8 & 13\hl{,}058.1 \\
6 & 9715.96 & 10\hl{,}479.6 & 12\hl{,}049.1 & 13\hl{,}373.4 & 14\hl{,}635.2 & 15\hl{,}185.6 & 13\hl{,}795 \\
7 & 10\hl{,}087 & 10\hl{,}877.3 & 12\hl{,}605.2 & 14\hl{,}223.3 & 15\hl{,}670.3 & 16\hl{,}380 & 14\hl{,}930.2 \\
8 & 10\hl{,}526.8 & 11378.8 & 13341.7 & 15248 & 16971.7 & 18216.1 & 16582.3 \\
9 & 11\hl{,}127.8 & 12\hl{,}082.7 & 14\hl{,}519.5 & 16\hl{,}951.3 & 19\hl{,}046.9 & 20\hl{,}773.9 & 18\hl{,}771.8 \\
10 & 11\hl{,}728.2 & 12\hl{,}813.2 & 15\hl{,}676 & 18\hl{,}406.1 & 20\hl{,}794.3 & 24\hl{,}015.7 & 22\hl{,}082.7 \\
...
3 & 9032.4 & 9610.46 & 10\hl{,}681.6 & 11\hl{,}350.9 & 12\hl{,}512.9 & 12\hl{,}392.4 & 11\hl{,}404.3 \\
4 & 9232.84 & 9855.5 & 11063 & 11\hl{,}913.4 & 13\hl{,}238.9 & 13\hl{,}353.2 & 12\hl{,}168.5 \\
5 & 9378.87 & 10\hl{,}036.2 & 11\hl{,}347.7 & 12\hl{,}369.6 & 13\hl{,}788.5 & 14\hl{,}219 & 12\hl{,}929 \\
6 & 9563.91 & 10\hl{,}256.7 & 11\hl{,}715.6 & 12\hl{,}988.2 & 14\hl{,}561.6 & 15\hl{,}110.5 & 13\hl{,}758.7 \\
7 & 10\hl{,}037.5 & 10\hl{,}785.2 &12\hl{,}429.3 & 13\hl{,}969.7 & 15\hl{,}629.4 & 16\hl{,}072.7 & 14\hl{,}651.6 \\
8 & 10\hl{,}332.3 & 11\hl{,}120.3 & 12\hl{,}974.7 & 14\hl{,}809.1 & 16\hl{,}765.2 & 17\hl{,}972.9 & 16\hl{,}439.1 \\
9 & 10\hl{,}934.6 & 11\hl{,}846.4 & 14\hl{,}132.9 & 16\hl{,}407.4 & 18\hl{,}587 & 20\hl{,}167.3 & 18\hl{,}278.5 \\
10 & 11\hl{,}319.5 & 12\hl{,}358.9 & 15\hl{,}074.5 & 17\hl{,}683.4 & 20\hl{,}102 & 23\hl{,}286.8 & 21\hl{,}439.7 \\
\midrule
2023 &  &  &  & & & & \\
\midrule
1 & 7473.59 & 8079.42 & 8857.77 & 8532.88 & 8642.03 & 8940.82 & 8737.73 \\
2 & 9179.37 & 9560.93 & 9889.56 & 9619.59 & 9502.14 & 9260.89 & 8893.31 \\
3 & 9285.35 & 10\hl{,}023 & 11\hl{,}304.4 & 12\hl{,}097.2 & 13\hl{,}066.2 & 13\hl{,}055 & 11\hl{,}870.5 \\
4 & 9260.65 & 9993.24 & 11324.5 & 12\hl{,}294.7 & 13\hl{,}624 & 14\hl{,}111.4 & 12\hl{,}725.8 \\
5 & 9612.99 & 10\hl{,}407.7 & 11\hl{,}850 & 12\hl{,}914.8 & 14\hl{,}185.6 & 14\hl{,}445.7 & 13\hl{,}030.6 \\
6 & 9612.99 & 10\hl{,}407.7 & 11\hl{,}850 & 12\hl{,}914.8 & 14\hl{,}185.6 & 14\hl{,}445.7 & 13\hl{,}030.6 \\
7 & 10\hl{,}105.5 & 10\hl{,}948.7 & 12\hl{,}646.3 & 14\hl{,}221.3 & 15\hl{,}852.4 & 16\hl{,}551.5 & 14\hl{,}997.2 \\
8 & 10\hl{,}551 & 11\hl{,}459.3 & 13\hl{,}401.9 & 15\hl{,}287.1 & 17\hl{,}177.8 & 18\hl{,}217.3 & 16\hl{,}436.4 \\
9 & 10\hl{,}830.2 & 11\hl{,}812.4 & 14\hl{,}092.6 & 16\hl{,}381.5 & 18\hl{,}713.8 & 20\hl{,}687.4 & 18\hl{,}410.8 \\
10 & 11\hl{,}191.6 & 12\hl{,}288.7 & 14\hl{,}890.2 & 17\hl{,}469.4 & 20\hl{,}034.6 & 23\hl{,}154.3 & 20\hl{,}893.2 \\
\bottomrule
\end{tabularx}
\end{table}
...
\newblock In {\em Satellite Remote Sensing of Terrestrial Hydrology}; Springer
  International Publishing: Cham, \hl{ Switzerland,} %MDPI: Newly added information, please confirm. The same for the following highlights.
 2022; pp. 131--176.
...
\newblock In Proceedings of the IGARSS 2023-2023 IEEE International
  Geoscience and Remote Sensing Symposium,  \hl{Pasadena, CA, USA, 16--21 July} 2023;  pp. 3502--3505.
...
\newblock Chapter 10-Urban land-use susceptibility and sustainability---Case
  ...
  Fiscus, D., Eds.; Academic Press:  \hl{Cambridge, MA, USA,} 
  2023; Volume~\hl{2,} %MDPI: We removed ``{\em Science of Sustainable   Systems}'', please confirm
 pp. 261--286.
...
\newblock In {\em Cloud-Based Remote Sensing with Google Earth Engine:
  Fundamentals and Applications}; Springer International Publishing: Cham, \hl{Switzerland},
  2024; pp. 97--114.
...
\newblock In Proceedings of the 2016 2nd International Conference on Next
  Generation Computing Technologies (NGCT),  \hl{Dehradun, India, 14--16 October } 2016; pp. 765--771.
...
\newblock In {\em Application of Remote Sensing and GIS in Natural Resources
  ...
  Cham,  \hl{Switzerland,} 2022; pp. 29--38.
...
\newblock In Proceedings of the 2023 China Automation Congress (CAC),  \hl{Chongqing, China, 17--19 November } 2023;
  pp. 4487--4492.
...
\newblock Assessment of vegetation indices for mapping burned areas using a
  ...
  collection.
\newblock {\em Adv. Space Res.} {\bf \hl{2025}%MDPI: We changed year, please confirm
}, \emph{75}, 1665--1685.
...
\newblock In Proceedings of the 2018 International Conference on Communication
  and Signal Processing (ICCSP),  \hl{Chennai, India, 3--5 April} 2018; pp. 1010--1013.
...
\newblock In Proceedings of the 2024 IEEE International Workshop on Metrology
  for Living Environment (MetroLivEnv),  \hl{Chania, Greece, 12--14 June} 2024; pp. 57--62.
...
\newblock In Proceedings of the 1997 IEEE International Conference on
  Intelligent Processing Systems (Cat. No.97TH8335),  \hl{Beijing, China,  28--31 October} 1997; Volume~2, pp.
  1143--1145.
...
\newblock In Proceedings of the 2008 Fifth International Conference on Fuzzy
  Systems and Knowledge Discovery, \hl{ Jinan, China, 18--20 October} 2008; Volume~2, pp. 541--545.
...
\newblock In Proceedings of the 2021 International Conference on Advanced
  Electrical Equipment and Reliable Operation (AEERO),   \hl{Beijing, China, 15--17 October} 2021; pp. 1--5.
...
\newblock In Proceedings of the 2023 International Conference on Pattern
  Recognition, Machine Vision and Intelligent Algorithms (PRMVIA),  \hl{Beihai, China, 24--26 March} 2023; pp.
  81--85.
...
\newblock In Proceedings of the 2019 International Conference on Information
  and Communications Technology (ICOIACT),  \hl{Yogyakarta, Indonesia,  24--25 July} 2019; pp. 937--942.
...
\newblock In Proceedings of the 2020 IEEE International Conference on High
  Voltage Engineering and Application (ICHVE),  \hl{Beijing, China, 6--10 September} 2020; pp. 1--4.
...
\newblock In {\em Encyclopedia of Tourism}; Springer International Publishing:
  Cham,  \hl{Switzerland}, 2016; pp. 266--267.
...
\newblock {\em J. Hydrol.} {\bf 2015}, {\em 526},~127--\hl{135.} %MDPI: We removed ``Drought processes, modeling, and mitigation,'', please confirm
\newblock 
...
\newblock {\em Curr. Opin. Environ. Sustain.} {\bf 2021},
  {\em 48},~44--\hl{52.} %MDPI: We removed ``The dryland social-ecological systems in changing environments,'', please confirm
\newblock 
...
\newblock In {\em Landscapes and Landforms of the Horn of Africa: Eritrea,
  Djibouti, Somalia}; Springer International Publishing: Cham, \hl{Switzerland}, 2022; pp.
  223--232.
...
\newblock {Chapter 1-History and formation of African Lakes}. In {\em Lakes
  of Africa}; El-Sheekh, M., Elsaied, H.E., Eds.; Elsevier:  \hl{Amsterdam, The Netherlands,} 
  2023; pp. 1--31.
...
\newblock In {\em The Red Sea: The Formation, Morphology, Oceanography and
  Environment of a Young Ocean Basin}; Springer: Berlin/Heidelberg,  \hl{Germany}, 2015; pp. 409--451.
...
\newblock {\em Chem. Geol.} {\bf 2013}, {\em 339},~16--\hl{29.} %MDPI: We removed ``Frontiers in Gas Geochemistry,'', please confirm
\newblock 
...
\newblock In Proceedings of the 2022 IEEE 27th International Conference on
  Emerging Technologies and Factory Automation (ETFA),  \hl{Stuttgart, Germany, 6--9 September} 2022; pp. 1--4.
...
\newblock In Proceedings of the 2011 Eighth International Joint Conference on
  Computer Science and Software Engineering (JCSSE),  \hl{Nakhonpathom, Thailand, 11--13 May} 2011; pp. 204--209.
...
\newblock In Proceedings of the 2023 International Conference on Educational
  Knowledge and Informatization (EKI), \hl{Guangzhou, China, 22--24 September}  2023; pp. 78--82.
...
\newblock In Proceedings of the 2011 17th Korea-Japan Joint Workshop on
  Frontiers of Computer Vision (FCV), \hl{Ulsan, Republic of Korea, 9--11 February } 2011; pp. 1--5.
...
\newblock In Proceedings of the IGARSS 2004. 2004 IEEE International Geoscience
  and Remote Sensing Symposium,  \hl{Anchorage, AK,  USA, 20--24 September} 2004; Volume~7, pp. 4598--4600.
...
\newblock In {\em The Geology of the Arabian-Nubian Shield}; Springer
  International Publishing: Cham, \hl{Switzerland}, 2021; pp. 139--151.
